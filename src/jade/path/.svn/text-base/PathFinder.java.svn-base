...
/**
 * Represents an algorithm for calculating paths on a {@code World}. These paths can be either
 * partial, meaning the path may not actually reach its goal, or complete, meaning it is either
 * {@code null} or reaches its goal.
 */
public abstract class PathFinder
{
    /**
     * Calculates and returns the partial path from the given start to end on the provided {@code
     * World}. Since the path is incomplete, it may or may not terminate at the provided end. Null
     * should never be returned from this method. If a path cannot be found, a partial path, or at
     * least an empty path should be returned.
     ...
     * path is incomplete, it may or may not terminate at the provided end.
     * @param world the world on which the path is calculated
     * @param start the start of the calculated path
     * @param end the intended end of the calculated path
     * @return a path from start to end on world
    ...
    /**
     * Returns a complete path from the given start to end on the provided {@code World}. Since the
     * path is complete, it will either be null, or terminate at the given end.
     * @param world the world on which the path is calculated
     * @param posX the x value of the start
     * @param posY the y value of the start
